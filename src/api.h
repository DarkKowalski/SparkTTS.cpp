...
#include <stdint.h>
    ...
    SPARK_TTS_API bool tts_init_voice_feature_extraction(tts_context *ctx,
                                                         const char *wav2vec_model_path,
                                                         const char *mel_spectrogram_model_path,
                                                         const char *bicodec_tokenizer_model_path,
                                                         const char *device_name);

    SPARK_TTS_API bool tts_init_text_to_speech(tts_context *ctx,
    ...
    // free after use
    SPARK_TTS_API int32_t *tts_extract_voice_features(tts_context *ctx,
                                                      const float *audio_data,
                                                      const size_t audio_size,
                                                      size_t *voice_features_size);

    SPARK_TTS_API void tts_text_to_speech(tts_context *ctx,
                                          const char *text,
